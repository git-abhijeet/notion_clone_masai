...
import { BlockNoteTextCompletion } from "@/components/ai/blocknote-text-completion-v2";
...
interface EditorProps {
    ...
    editable?: boolean;
    aiTextCompletion?: boolean;
}
function Editor({
    onChange,
    initialContent,
    editable,
    aiTextCompletion = false,
}: EditorProps) {
    ...
    return (
        <div className="relative">
            ...
            />
            {editable && aiTextCompletion && (
                <BlockNoteTextCompletion editor={editor} enabled={true} />
            )}
